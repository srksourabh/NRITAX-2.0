...
function Wordmark({
  ...
  }, "NRITAX ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-figure)',
      fontWeight: 'var(--weight-medium)',
...
function AppShell({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: n.onClick,
    style: {
      background: n.active ? 'rgba(252,253,252,0.10)' : 'transparent',
      border: 'none',
  ...
  }, right)), /*#__PURE__*/React.createElement("main", {
    style: {
      flex: 1,
      minHeight: 0,
      overflow: 'auto'
...
Object.assign(__ds_scope, { Wordmark, AppShell, StickyActionBar });
