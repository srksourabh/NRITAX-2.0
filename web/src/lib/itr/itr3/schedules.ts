        ...
        tables: [
          ...
          },
          {
            ...
            columns: [
              ...
              { key: 'OrigFiled', label: 'Original / revised return filed for that year?', type: 'text' },
              { key: 'UpdatedFiled', label: 'Updated return filed for that year?', type: 'text' },
            ],
          },
        ],
      },
        ...
        tables: [
          ...
          },
          {
            ...
            columns: [
              ...
              { key: 'TIN', label: 'Taxpayer identification number', type: 'text' },
              { key: 'TaxPaid', label: 'Total taxes paid outside India', type: 'num' },
              { key: 'Relief', label: 'Total tax relief available', type: 'num' },
              { key: 'Section', label: 'Section 90, 90A or 91', type: 'text' },
            ],
          },
        ],
      },
        ...
        tables: [
          {
            ...
            columns: [
              ...
              { key: 'JointHolders', label: 'Name of joint holder(s), if any', type: 'text' },
              { key: 'AccountNo', label: 'Account number', type: 'text', path: 'BankAccountNo' },
              { key: 'AccountStatus', label: 'Account status (active / closed)', type: 'text' },
              { key: 'Balance31Mar', label: 'Account balance as on 31 March', type: 'num' },
        ...
        tables: [
          {
            ...
            source: 'user',
            columns: [
              { key: 'DepositDate', label: 'Date of deposit', type: 'date' },
              { key: 'Challan', label: 'Serial number of challan', type: 'text' },
